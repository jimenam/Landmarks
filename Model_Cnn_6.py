...
tbCallBack =  TensorBoard(log_dir='/Tensorboard/My_Model_6', histogram_freq=0, write_graph=True, write_images=True)
early_stopping = EarlyStopping(monitor='val_acc', patience=3)

model.fit_generator(
        train_generator,
        epochs=20,
        callbacks=[tbCallBack, early_stopping, ModelCheckpoint('model_6.h5', save_best_only=True)],
