...
model.add(Conv2D(32, kernel_size=(3, 3),
                 activation='relu',
                 input_shape=(image_size,image_size,3), kernel_initializer='glorot_uniform'))
...
tbCallBack =  TensorBoard(log_dir='/Tensorboard/My_Model_5', histogram_freq=0, write_graph=True, write_images=True)
early_stopping = EarlyStopping(monitor='val_loss', patience=3)

model.fit_generator(
        train_generator,
        epochs=20,
        callbacks=[tbCallBack, early_stopping, ModelCheckpoint('model_5.h5', save_best_only=True)],
